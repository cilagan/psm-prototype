...
public abstract class AbstractTransferObject implements Serializable, Cloneable {
    ...
    //JSHRADER this method is not final on purpose, it is a default implementation used most commonly
    ...
    //JSHRADER checkstyle doesn't like any usage at all of this method and wants this to be final.
